...
const data_evento = new Date("Sep 1, 2023 12:00:00");
...
const contar_tempo = setInterval(function() {
    ...
    if (tempo_ate_evento <= 0) {
        ...
        document.getElementById('date_counter').innerHTML = 'EVENTO EXPIRADO';
    } else {
        ...
        document.getElementById('date_counter').innerHTML = `${dias_ate_evento}d ${horas_ate_evento}h ${minutos_ate_evento}m ${segundos_ate_evento}s`;
    }
